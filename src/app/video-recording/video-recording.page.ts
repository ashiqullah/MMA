...
import {VideoUploadPage} from '../video-upload/video-upload.page';
...
export class VideoRecordingPage implements OnInit, AfterViewInit, OnDestroy {
  ...
  async playVideo(content,filename) {
